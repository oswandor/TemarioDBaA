...
2. Worker Nodes (Nodos de Trabajo):
   ...
   - Container Runtime: Es el motor que ejecuta los contenedores, como Docker o containerd. Se encarga de crear y administrar los contenedores en los nodos de trabajo.
